:original_name: evs_04_0046.html
...
-  :ref:`Obtain the Project ID by Calling an API <evs_04_0046__en-us_topic_0121673684_section86806471133>`
-  :ref:`Obtain the Project ID from the Console <evs_04_0046__en-us_topic_0121673684_section11508201712212>`

.. _evs_04_0046__en-us_topic_0121673684_section86806471133:
...
The API used to obtain a project ID is GET https://{Endpoint}/v3/projects. {Endpoint} is the IAM endpoint and can be obtained from `Regions and Endpoints <https://docs.sc.otc.t-systems.com/en-us/endpoint/index.html>`__. For details about API authentication, see :ref:`Authentication <evs_04_0012>`.
...
.. _evs_04_0046__en-us_topic_0121673684_section11508201712212:
